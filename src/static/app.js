              ...
              <ul class="participants-list" style="list-style-type: none; padding-left: 0;">
                ${details.participants.map(p => `
                  <li class="participant-item" style="display: flex; align-items: center;">
                    <span>${p}</span>
                    <button class="delete-participant" title="Remove" data-activity="${name}" data-email="${p}" style="margin-left: 8px; background: none; border: none; cursor: pointer; color: #c00; font-size: 1.2em;">
                      &#128465;
                    </button>
                  </li>
                `).join("")}
